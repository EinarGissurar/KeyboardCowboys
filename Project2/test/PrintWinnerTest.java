 ...
 * Then we capture the PrintStream from the function for different inputs in printWinner.
 * For input 1 we expect to get "Player 1 wins!", for input 2 we expect "Player 2 wins!",
